...
class ServicesLocater {
  Future<void> init() async {
    ...
    // usecases
    getIt.registerLazySingleton<GetEventsUseCase>(() => GetEventsUseCase(reporsitory: getIt()));

    // repository
    getIt.registerLazySingleton<BaseEventsReporsitory>(() => EventRepositoryImple(eventsRemoteDataSource: getIt(), networkInfo: getIt()));
    // datasources
    getIt.registerLazySingleton<BaseEventsRemoteDataSource>(() => EventsRemoteDataSourceImplement(apiConsumer: getIt()));
